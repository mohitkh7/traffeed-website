app.controller('DraftsController', ['$scope', '$firebaseArray', '$firebaseObject','$location','FBURL2','FBURL','FBURL3', function($scope,$firebaseArray, $firebaseObject, $location, FBURL2, FBURL,FBURL3){
	var link = new Firebase(FBURL3);
	//gettin all the data
